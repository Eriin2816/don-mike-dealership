...
const brandData: Record<string, BrandData> = {
  gmc: {
    name: "gmc",
    displayName: "GMC",
    heroHeadline: "Built Tough.\nRefined for Life.",
    heroSub:
      "From the Sierra's hauling power to the Yukon's commanding presence — browse our full GMC lineup built for North Florida work and play.",
    models: [
      {
        model: "Sierra 1500",
        type: "Truck",
        ...
        summary:
          "The Sierra 1500 combines truck-grade capability with refined comfort — ideal for tradespeople, contractors, and weekend haulers across Alachua County.",
      ...
      },
      {
        ...
        summary:
          "When the job demands more, the Sierra 2500HD delivers — maximum towing, Duramax diesel option, and ProGrade Trailering System.",
      ...
      },
      {
        ...
        summary:
          "The Yukon commands the road with its bold GMC styling, three rows, and available Super Cruise hands-free driving technology.",
      ...
      },
      {
        ...
        summary:
          "Need more space? The Yukon XL stretches the wheelbase to deliver best-in-class passenger and cargo volume for large families.",
      ...
      },
      {
        ...
        summary:
          "Room for the whole family and then some. The Acadia delivers comfort, technology, and GMC dependability for Gainesville households.",
      ...
      },
      {
        ...
        summary:
          "The Terrain punches above its class with available turbocharged power, GMC Pro Safety, and a premium interior at an accessible price.",
  ...
  honda: {
    name: "honda",
    displayName: "Honda",
    heroHeadline: "Trusted. Proven.\nBuilt to Last.",
    heroSub:
      "Honda's legendary reliability meets Gainesville's everyday demands — from the fuel-efficient Civic to the adventure-ready Pilot.",
    models: [
      {
        model: "Accord",
        type: "Sedan",
        ...
        summary:
          "Refined, fuel-efficient, and built to last — the Accord is a top pick for professionals and commuters across Alachua County.",
      ...
      },
      {
        ...
        summary:
          "Sporty, efficient, and packed with Honda Sensing safety tech — the Civic is the go-to for first-time buyers and UF students.",
      ...
      },
      {
        ...
        summary:
          "Versatile, safe, and cargo-smart. The CR-V handles school runs, road trips, and everything between with available AWD.",
      ...
      },
      {
        ...
        summary:
          "The Pilot's 3-row interior and Honda's proven reliability make it a standout for Gainesville families who need room and peace of mind.",
      ...
      },
      {
        ...
        summary:
          "Magic Slide seats, CabinWatch rear camera, and Honda's reliability — the Odyssey makes long Florida road trips genuinely enjoyable.",
      ...
      },
      {
        ...
        summary:
          "The HR-V's Magic Seat system packs surprising cargo flexibility into a compact footprint — perfect for Gainesville city driving.",
  ...
  toyota: {
    name: "toyota",
    displayName: "Toyota",
    heroHeadline: "Dependable. Proven.\nBuilt for Florida.",
    heroSub:
      "Toyota's class-leading resale value and long-term reliability make every model a smart investment for Gainesville drivers.",
    models: [
      {
        model: "Camry",
        type: "Sedan",
        ...
        summary:
          "Class-leading resale value, smooth ride, and long-term dependability that Gainesville commuters have trusted for decades.",
      ...
      },
      {
        ...
        summary:
          "The world's best-selling car for good reason — efficient, dependable, and low-cost to own. A smart first or second vehicle for any buyer.",
      ...
      },
      {
        ...
        summary:
          "One of the best-selling crossovers in Florida — rugged enough for weekends, fuel-smart enough for daily driving, with hybrid available.",
      ...
      },
      {
        ...
        summary:
          "The Highlander delivers 3-row family comfort with Toyota's legendary build quality — available hybrid trims keep fuel costs manageable.",
      ...
      },
      {
        ...
        summary:
          "Best-in-class resale value and off-road capability — the Tacoma is North Florida's most sought-after mid-size pickup.",
      ...
      },
      {
        ...
        summary:
          "Body-on-frame toughness, legendary trail capability, and a devoted following — the 4Runner is for drivers who demand more from their SUV.",
  ...
  "mercedes-benz": {
    ...
    heroHeadline: "German Precision.\nGainesville Accessible.",
    heroSub:
      "The three-pointed star — AMG performance, MBUX technology, and luxury that Gainesville professionals can attain.",
    models: [
      {
        model: "C-Class",
        type: "Sedan",
        ...
        summary:
          "The entry point to Mercedes luxury — AMG styling, MBUX infotainment, and the prestige of the three-pointed star at an attainable payment.",
      ...
      },
      {
        ...
        summary:
          "The E-Class is the benchmark mid-size luxury sedan — more tech, more space, and more presence for Gainesville executives.",
      ...
      },
      {
        ...
        summary:
          "Elevated ride, premium materials, and advanced tech — the GLC is the logical step-up for Gainesville professionals ready for their first Mercedes.",
      ...
      },
      {
        ...
        summary:
          "The GLE offers a bigger footprint, available 3rd row, and commanding road presence — the choice for families who refuse to compromise on luxury.",
      ...
      },
      {
        ...
        summary:
          "Compact, tech-forward, and unmistakably Mercedes — the A-Class puts the three-pointed star within reach for first-time luxury buyers.",
      ...
      },
      {
        ...
        summary:
          "Four-door coupe styling with AMG lines and MBUX tech — the CLA is the most striking entry point to the Mercedes family.",
...
export async function generateMetadata({
  ...
  if (!brand) return {};
  return {
    title: `${brand.displayName} Collection | Don Mike Auto Dealership — Gainesville, FL`,
    description: `Browse our full ${brand.displayName} lineup at Don Mike Auto Dealership in Gainesville, FL. Find the right model for your budget and lifestyle.`,
    openGraph: {
      title: `${brand.displayName} Collection | Don Mike Auto Dealership`,
      description: `${brand.displayName} models matched to Gainesville buyers.`,
      images: [{ url: "https://don-mike-dealership.vercel.app/opengraph-image", width: 1200, height: 630, alt: `Don Mike Auto Dealership — ${brand.displayName} Collection` }],
    },
  };
}
        ...
        <div className="bg-[#F0F6FF] border-b border-[#C8D6E5]/60 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <p className="text-[#475569] text-sm">
              <strong className="text-[#1E3A5F]">6 {brand.displayName} models shown</strong> — representative vehicles. Actual inventory varies. Book a call to check availability and payments.
            </p>
            <Link
              href="/book-a-call"
            ...
            >
              Check {brand.displayName} Availability
            </Link>
          </div>
        </div>
